...
namespace BEPZA_MEDICAL.Web.Helpers
{
    public static class HtmlPrefixScopeExtensions
    {
        ...
        public static IDisposable BeginCollectionItem(this HtmlHelper html, string collectionName)
        {
            ...
            html.ViewContext.Writer.WriteLine(string.Format("<input type=\"hidden\" name=\"{0}.index\" autocomplete=\"off\" value=\"{1}\" />", !string.IsNullOrEmpty(previousPrefix) ? string.Concat(previousPrefix.Trim('.'), ".", collectionName) : collectionName, html.Encode(itemIndex)));
