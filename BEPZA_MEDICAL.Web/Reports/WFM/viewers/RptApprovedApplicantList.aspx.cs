...
{
    public partial class RptApprovedApplicantList : ReportBase
    {
        #region Fields
        ...
        #region Ctor
        public RptApprovedApplicantList()
        {
        ...
        protected void btnViewReport_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               GenerateReport(strZoneId, empId, year);
            }
            catch (Exception ex)
            {
        ...
        public void GenerateReport(string strZoneList, string empId, string year)
        {
            #region Processing Report Data

            rvEmployeeInfo.Reset();
            rvEmployeeInfo.ProcessingMode = ProcessingMode.Local;
            rvEmployeeInfo.LocalReport.ReportPath = Server.MapPath("~/Reports/WFM/rdlc/ApprovedApplicantList.rdlc");

            var data = (from s in base.wfmContext.sp_WFM_RptApprovedApplicantList(strZoneList, empId, year) select s).ToList();
            ...
            ReportDataSource dataSource = new ReportDataSource("dsApprovedApplicantList", data);
            ...
            //ExportToPDF
            String newFileName = "ApprovedApplicantList_" + Guid.NewGuid() + ".pdf";
