<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptFDRSummary.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.FMS.viewers.RptFDRSummary" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control select-single" runat="server" ID="ddlAmountType">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div> 
