<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptMonthlyFDRInstallmentReceivable.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.FMS.viewers.RptMonthlyFDRInstallmentReceivable" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control select-single required" runat="server" ID="ddlYear">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control select-single required" runat="server" ID="ddlMonth">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
