<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptFDRClosing.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.FMS.viewers.RptFDRClosing" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:TextBox ID="txtMaturityDateFrom" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtMaturityDateTo" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <asp:TextBox ID="txtClosingDateFrom" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtClosingDateTo" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div>
                <div id="rptContainer" style="width: 100%; height: 100%; display: block; text-align: center;">
                    ...
                    <rsweb:ReportViewer ID="rvFDRClosing" runat="server" Width="100%" ShowPrintButton="true" SkinID="" AsyncRendering="true" Visible="true"
                        Height="100%" InteractiveDeviceInfos="(Collection)"
                        OnReportRefresh="rvFDRClosing_ReportRefresh" SizeToReportContent="true">
                    </rsweb:ReportViewer>
                </div>
                <div class="clear">
                </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvFDRClosing" />
        </Triggers>
    </asp:UpdatePanel>
