<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptBankBranchInfo.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.FMS.viewers.RptBankBranchInfo" %>
        ...
        <ContentTemplate>
            ...
            <div>
                <div id="rptContainer" style="width: 100%; height: 100%; display: block; text-align: center;">
                    ...
                    <rsweb:ReportViewer ID="rvFDRInfo" runat="server" Width="100%" ShowPrintButton="true" SkinID="" AsyncRendering="true" Visible="true" ZoomMode="PageWidth" SizeToReportContent="True"
                        Height="100%" InteractiveDeviceInfos="(Collection)"
                        OnReportRefresh="rvFDRInfo_ReportRefresh">
                    </rsweb:ReportViewer>
                </div>
                <div class="clear">
                </div>
