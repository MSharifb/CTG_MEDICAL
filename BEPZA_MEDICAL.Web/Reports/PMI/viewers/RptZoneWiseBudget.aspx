<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptZoneWiseBudget.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PMI.viewers.RptZoneWiseBudget" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div>
                <rsweb:ReportViewer ID="rvZoneWiseBudget" runat="server" Width="100%" Height="100%" AsyncRendering="true" Visible="true" SizeToReportContent="True"
                    OnReportRefresh="rvZoneWiseBudget_ReportRefresh">
                </rsweb:ReportViewer>
                <div class="clear">
                </div>
            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvZoneWiseBudget" />
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
