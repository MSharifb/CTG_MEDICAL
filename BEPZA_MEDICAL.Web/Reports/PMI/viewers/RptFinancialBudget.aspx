<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptFinancialBudget.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PMI.viewers.RptFinancialBudget" %>
        ...
        <ContentTemplate>
            ...
            <div class="GroupBox">
                <div class="row">
                    ...
                    <span class="label-right">Budget Type<label style='color: red'>
                        *</label></span>
                    <span class="field">
