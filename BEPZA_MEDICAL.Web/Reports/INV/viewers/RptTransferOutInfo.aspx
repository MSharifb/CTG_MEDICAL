<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptTransferOutInfo.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.INV.viewers.RptTransferOutInfo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="GroupBox" style="height: 319px">
                ...
                <div class="row">
                    ...
                    <span class="field">
                        <asp:DropDownList ID="ddlTransferredTo" runat="server"></asp:DropDownList>
                    </span>
            ...
            <div>
                <rsweb:ReportViewer ID="rvTransferOutInfo" runat="server" Width="100%" Height="100%" Visible="false"
                    OnReportRefresh="rvTransferOutInfo_ReportRefresh">
                </rsweb:ReportViewer>
                <div class="clear">
                </div>
            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvTransferOutInfo" />
