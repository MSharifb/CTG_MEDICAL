...
{
    public partial class RptAdmissionFeesLedger : ReportBase
    {
        #region Page Event
        ...
        private void GenerateReport(int jobAdvertisementInfoId, int designationId)
        {
            ...
            rvShortListedApplicant.LocalReport.ReportPath = Server.MapPath("~/Reports/PRM/rdlc/RptAdmissionFeesLedger.rdlc");
