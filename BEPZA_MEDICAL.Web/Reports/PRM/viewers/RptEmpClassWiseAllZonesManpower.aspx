<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptEmpClassWiseAllZonesManpower.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.RptEmpClassWiseAllZonesManpower" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control required" runat="server" ID="ddlMonth" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control required" runat="server" ID="ddlYear" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
