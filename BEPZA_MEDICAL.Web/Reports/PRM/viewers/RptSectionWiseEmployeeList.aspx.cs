...
{
    public partial class RptSectionWiseEmployeeList : ReportBase
    {
        #region Fields
        ...
        #region Ctor
        public RptSectionWiseEmployeeList()
        {
        ...
        protected void btnViewReport_Click(object sender, EventArgs e)
        {
            ...
            GenerateReport(list, sectionId, generationDate);
        }
        ...
        public void GenerateReport(List<PRM_ZoneInfo> list, int sectionId, string generationDate)
        {
            rvEmployeeInfo.Reset();
            rvEmployeeInfo.ProcessingMode = ProcessingMode.Local;
            rvEmployeeInfo.LocalReport.ReportPath = Server.MapPath("~/Reports/PRM/rdlc/RptSectionWiseEmployeeList.rdlc");
            ...
            if (sectionId > 0) data = data.Where(q => q.SectionId == sectionId).OrderBy(x => x.DesignationSortingOrder).ToList();
            ...
            {
                rvEmployeeInfo.LocalReport.DataSources.Add(new ReportDataSource("DSSectionWiseEmployeeListRpt", data));
            ...
            //ExportToPDF
            String newFileName = "SectionWiseEmployeeList_" + Guid.NewGuid() + ".pdf";
