<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RecreationLeave.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.RecreationLeave" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6" hidden="hidden">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control select-single" runat="server" ID="ddlCategory" AppendDataBoundItems="true" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
