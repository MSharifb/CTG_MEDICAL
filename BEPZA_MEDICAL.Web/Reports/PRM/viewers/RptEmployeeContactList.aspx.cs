...
{
    public partial class RptEmployeeContactList : ReportBase
    {
        #region Page Event
        ...
        protected void btnViewReport_Click(object sender, EventArgs e)
        {
            ...
            GenerateReport(strZoneId, departmentId);
        }

        #endregion

        #region Generate Report
        private void GenerateReport(string ZoneInfoIds, int departmentId)
        {
            rvDesignationWiseManpower.Reset();
            rvDesignationWiseManpower.ProcessingMode = ProcessingMode.Local;
            rvDesignationWiseManpower.LocalReport.ReportPath = Server.MapPath("~/Reports/PRM/rdlc/RptEmployeeContactList.rdlc");

            #region Processing Report Data
            var data = (from s in base.context.SP_PRM_EmployeeContactList(ZoneInfoIds, departmentId) select s).ToList();
            #endregion
            ...
            rvDesignationWiseManpower.LocalReport.DataSources.Add(new ReportDataSource("DSEmployeeContactList", data));
            ...
            //ExportToPDF
            String newFileName = "EmployeeContactInfo_" + Guid.NewGuid() + ".pdf";
        ...
        private void PopulateDropdownList()
        {
            ...
            ddlDepartment.DataSource = context.PRM_Division.Where(q=>q.ZoneInfoId==LoggedUserZoneInfoId).OrderBy(x => x.Id).ToList();
