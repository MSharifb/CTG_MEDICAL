<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptDistrictWiseApplicantInfo.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.RptDistrictWiseApplicantInfo" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control" runat="server" ID="ddlDistrict" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
