<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptPromotionSheetForOfficer.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.RptPromotionSheetForOfficer" %>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:DropDownList CssClass="form-control select-single required" ID="ddlDepartment" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:DropDownList CssClass="form-control select-single required" ID="ddlDesignation" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
                </div>
