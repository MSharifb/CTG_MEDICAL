<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="HigherGradeSelection.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.HigherGradeSelection" %>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <asp:RadioButtonList ID="rbReportType" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server">
                                    <asp:ListItem class="radio-inline" Text="Higher Grade Selection" Value="HG" Selected="True"/>
                                    <asp:ListItem class="radio-inline" Text="Promotion " Value="PT" />
                                </asp:RadioButtonList> 
                                    </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control select-single" runat="server" ID="ddlDesignation" AppendDataBoundItems="true" ClientIDMode="Static">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-8">
                                        <asp:TextBox ID="txtYears" runat="server" CssClass="number"  Width="100px"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-sm-6"> 
                                <label class="col-sm-4 control-label">
                                    As on&nbsp;<span class="required-field">*</span>
                                </label>
                                <div class="col-sm-8">
