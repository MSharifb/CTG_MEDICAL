<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptDesignationWiseEmpList.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.RptDesignationWiseEmpList" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:DropDownList CssClass="form-control" runat="server" ID="ddlDesignation">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        </div>
