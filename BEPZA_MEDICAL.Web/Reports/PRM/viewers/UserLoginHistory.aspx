<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="UserLoginHistory.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.PRM.viewers.UserLoginHistory" %>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtFromDate" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <asp:TextBox ID="txtToDate" runat="server" CssClass="datePicker" Width="100px"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>
