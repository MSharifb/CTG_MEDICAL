...
{
    public partial class RptPromotionSheetForStaff : ReportBase
    {
        #region Fields
        ...
        #region Ctor
        public RptPromotionSheetForStaff()
        {
        ...
        public void GenerateReport(string fromDate, int departmentId, int DesignationId, string strZoneId)
        {
            ...
            rvTestResult.LocalReport.ReportPath = Server.MapPath("~/Reports/PRM/rdlc/RptPromotionSheetForStaff.rdlc");

            var data = (from s in base.prmContext.SP_PRM_RptPromotionSheetForStaff(fromDate, departmentId, DesignationId, strZoneId) select s).ToList();
            ...
            ReportDataSource dataSource = new ReportDataSource("DSPromotionSheetForStaff", data);
            ...
            //ExportToPDF
            String newFileName = "PromotionSheetForStaff_" + Guid.NewGuid() + ".pdf";
        ...
        void localReport_SubreportProcessing(object sender, SubreportProcessingEventArgs e)
        {
            ...
            switch (e.ReportPath)
            {
                case "RptPromotionSheetForStaffACR":
                    data = (from s in base.prmContext.SP_PRM_RptPromotionSheetForStaffACR(fromDate, departmentId, designationId, strZoneId) select s).Where(x => x.EmpID == empId).ToList();
                    dsName = "DSPromotionSheetForStaffACR";
                    break;
