<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptEmployeeWiseAnsarDetails.aspx.cs" Inherits="ERP_BEPZA.Web.Reports.AMS.viewers.RptEmployeeWiseAnsarDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="GroupBox">
                <rsweb:ReportViewer ID="rvEmployeeWiseAnsarDetails" runat="server" Width="100%" Height="100%"
                    OnReportRefresh="rvEmployeeWiseAnsarDetails_ReportRefresh">
                </rsweb:ReportViewer>
                <div class="clear">
                </div>
            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvEmployeeWiseAnsarDetails" />
        </Triggers>
    </asp:UpdatePanel>
