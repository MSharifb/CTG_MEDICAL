<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptAnsarDetails.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.AMS.viewers.RptAnsarDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div class="GroupBox">
                <div class="row">
                    <span class="label">Ansar Id <label style='color: red'>
                        *</label></span>
                    <span class="field">
            ...
            <div>
                <rsweb:ReportViewer ID="rvAnsarDetails" runat="server" Width="100%" Height="100%" Visible="false"
                    OnReportRefresh="rvAnsarDetails_ReportRefresh">
                </rsweb:ReportViewer>
                <div class="clear">
                </div>
            </div>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="rvAnsarDetails" />
        </Triggers>
    </asp:UpdatePanel>
            ...
            $(document).ready(function () {
                ...
                $("#<%=txtEmployeeId.ClientID %>").autocomplete({
                    source: function (request, response) {
                        ...
                        $.ajax({
                            url: "AMSAutocomplete.aspx/GetEmployeeList",
