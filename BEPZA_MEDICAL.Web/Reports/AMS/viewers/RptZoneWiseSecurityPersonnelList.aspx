<%@ Page Title="" Language="C#" MasterPageFile="~/Reports/Common/MasterPage/ReportMaster.Master" AutoEventWireup="true" CodeBehind="RptZoneWiseSecurityPersonnelList.aspx.cs" Inherits="BEPZA_MEDICAL.Web.Reports.AMS.viewers.RptZoneWiseSecurityPersonnelList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
            ...
            <div>
                <rsweb:ReportViewer ID="rvZoneWiseSecurityPersonnelList" runat="server" Width="100%" Height="100%" Visible="false"
                    OnReportRefresh="rvZoneWiseSecurityPersonnelList_ReportRefresh">
                </rsweb:ReportViewer>
                <div class="clear">
                </div>
            </div>
