...
namespace BEPZA_MEDICAL.Web.Areas.FAR.Controllers
{
    public class LocationController : BaseController
    {
        ...
        #region Ctor
        public LocationController(FARCommonService farCommonService)
        {
        ...
        public ActionResult GetList(JqGridRequest request, LocationViewModel viewModel)
        {
            string filterExpression = String.Empty;
            int totalRecords = 0;
            var list = (from loc in _farCommonService.FARUnit.LocationRepository.GetAll()
                        where (loc.ZoneInfoId == LoggedUserZoneInfoId)
        ...
        public ActionResult Create(LocationViewModel model)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                        ...
                        _farCommonService.FARUnit.LocationRepository.Add(entity);
        ...
        {
            var entity = _farCommonService.FARUnit.LocationRepository.GetByID(id);
        ...
        public ActionResult Edit(LocationViewModel model)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    model.ZoneInfoId = LoggedUserZoneInfoId;
                    var entity = model.ToEntity();
                    _farCommonService.FARUnit.LocationRepository.Update(entity);
                    _farCommonService.FARUnit.LocationRepository.SaveChanges();
                    model.errClass = "success";
