...
namespace BEPZA_MEDICAL.Web.Areas.FAM.Models.CentralBudgetInformation
{
    public class CentralBudgetInformationModel
    {
        #region Ctor
        public CentralBudgetInformationModel()
        {
            ...
            this.CentralBudgetList = new List<CentralBudget>();
        ...
        public string NodeApprovalType { get; set; }
        ...
        public ICollection<CentralBudget> CentralBudgetList { get; set; }
        ...
        public class CentralBudget
        {
            #region Ctor
            public CentralBudget()
            {
                this.IUser = HttpContext.Current.User.Identity.Name;
                this.EUser = this.IUser;
                this.IDate = DateTime.Now;
            ...
            public int CentralBudgetId { get; set; }
