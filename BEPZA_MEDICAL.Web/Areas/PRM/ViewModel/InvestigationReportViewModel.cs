...
{
    public class InvestigationReportViewModel : BaseViewModel
    {
        #region Ctor
        public InvestigationReportViewModel()
        {
        ...
        [Required]
        [DisplayName("Date of Investigation")]
        [UIHint("_RequiredDate")]
        public DateTime? DateOfInvestigation { get; set; }


        [DisplayName("Investigation Details")]
        [UIHint("_MultiLine")]
        ...
        [UIHint("_ReadOnly")]
        public string PreparedByEmpId { get; set; }
        ...
        [UIHint("_ReadOnly")]
        public string PreparedByDesignationName { get; set; }
