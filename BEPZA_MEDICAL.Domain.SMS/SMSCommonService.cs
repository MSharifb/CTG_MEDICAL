...
namespace BEPZA_MEDICAL.Domain.SMS
{
    public class SMSCommonService
    {
        #region Fields

        SMS_UnitOfWork _smsUnit;

        #endregion

        #region Ctor

        public SMSCommonService(SMS_UnitOfWork unitOfWork)
        {
            _smsUnit = unitOfWork;
        }
        ...
        public SMS_UnitOfWork SMSUnit { get { return _smsUnit; } }
